...
def generate_pages_recursive(dir_path_content: str, tmp_path: str, dst_dir_path: str):
    ...
    for entry_name  in entry_names:
            ...
            if isfile(dir_path):
                ...
                generate_page(dir_path, tmp_path, dst_path)
            else:
                print(f"Creating new directory: '{dst_path}'")
                mkdir(dst_path)
                generate_pages_recursive(dir_path, tmp_path ,dst_path)